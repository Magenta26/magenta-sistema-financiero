-- ============================================================
-- aplicar_natillera.sql — Migración 014 (Natillera: caja de ahorro).
-- Pegar completo en el SQL Editor de Supabase y ejecutar.
-- Idempotente: se puede re-ejecutar sin error y NO borra datos.
--
-- PRINCIPIO DE INDEPENDENCIA: tablas standalone (prefijo natillera_) que NO
-- referencian movimientos / catalogo_cuentas / rubros_er ni las vistas
-- v_er_* / v_bg. No aparece en ER ni BG; no es cuenta por pagar ni gasto.
-- ============================================================
